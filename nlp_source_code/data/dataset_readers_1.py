    ...
    def _read_origin_dataset(self, split):
        ...
        if split not in self.cached_origData:
            ...
            if self.dataset_stash!="hellaswag":
                huggingFace_data = load_dataset(*self.dataset_stash,
                    #split="train",
                    split="validation",
                    # split=load_split,
                )
            else:
                #  huggingFace_data = load_dataset('csv', data_files="./src/dataset/h-swag/val_full.csv",
                #     # split="train",
                #     split="validation",
                # )
                huggingFace_data = load_dataset('json', data_files='./src/dataset/h-swag/haha.jsonl', split="train")
                # huggingFace_data = load_dataset('./src/dataset/h-swag',
                #     # split="train",
                #     split="validation",
                # )
